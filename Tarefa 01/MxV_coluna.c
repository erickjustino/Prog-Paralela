...
void MxV_coluna(double** matriz, const double* vetor, double* resultado, int linhas, int colunas) {
    for (int i = 0; i < linhas; i++) {
        resultado[i] = 0.0;
    }
...
int main() {
    ...
    printf("### CÁLCULO DA MEDIANA DO TEMPO DA OPERAÇÃO (Acesso por coluna externa) ###\n");
    printf("-------------------------------------------------------------------\n");
    ...
    for (int k = 0; k < AMOSTRAS; k++) {
        ...
        MxV_coluna(matriz, vetor, resultado, N, N);
    ...
    printf("-------------------------------------------------------------------\n");
    printf("-> MEDIANA DO TEMPO DA MULTIPLICAÇÃO: %.6f segundos\n", mediana);
    printf("-------------------------------------------------------------------\n");
